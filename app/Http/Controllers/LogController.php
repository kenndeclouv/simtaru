...
class LogController extends Controller
{
    public function __construct()
    {
        ...
        $this->middleware('can:view log')->only(['index', 'show']);
        $this->middleware('can:delete log')->only(['destroy']);
        $this->middleware('can:download log')->only(['download']);
    }
    ...
    public function index()
    {
        ...
        return view('log.index', compact('logs', 'stats'));
    }
    ...
    public function show($filename)
    {
        ...
        return response()->view('log.show', compact('logs', 'filename'));
    }
    ...
    public function destroy($filename)
    {
        ...
        return redirect()->route('logs.index')->with('success', 'Log file deleted successfully!');
    }
