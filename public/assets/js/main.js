        ...
        e.isOpen
          ? ((document.body.style.overflow = "hidden"),
            ...
            (n = document.querySelector(".aa-DetachedCancelButton")) &&
              (n.innerHTML =
                '<span class="text-body-secondary">[esc]</span> <span class="icon-base icon-md fa-solid fa-cross text-heading"></span>'),
            ...
            <div class="search-no-results-wrapper">
              <div class="d-flex justify-content-center align-items-center h-100">
                <div class="text-center text-heading">
                  <i class="icon-base fa-solid fa-folder text-body-secondary icon-48px mb-4"></i>
