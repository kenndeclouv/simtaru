                      ...
                      "light" ===
                        ...
                        ("dark" ===
                          document
                            ...
                            .getAttribute("data-bs-theme") && (i = !0),
                        !0 === i &&
                          o
                            .querySelector(
                              ".template-customizer-semi-dark-switch"
                  ...
                  value: function () {
                    document.documentElement.lang =
                      localStorage.getItem(
                        "templateCustomizer-" + window.templateName + "--Lang"
                      ) || "en";
                    this._hasControls("rtl") &&
                      document.documentElement.setAttribute(
                        "dir",
          ...
          (D.THEMES = [
            {
              name: "light",
              title: "Light",
              image: '<i class="fa-solid fa-sun fs-sm icon-base mb-0"></i>',
            },
            {
              name: "dark",
              title: "Dark",
              image: '<i class="fa-solid fa-moon fs-sm icon-base mb-0"></i>',
            },
            {
              name: "system",
              title: "System",
              image: '<i class="fa-solid fa-gears fs-sm icon-base mb-0"></i>',
            },
          ]),
          (D.SKINS = [
